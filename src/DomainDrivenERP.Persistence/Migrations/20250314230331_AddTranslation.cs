        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FallbackLanguageCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    UseResourceKeys = table.Column<bool>(type: "bit", nullable: false),
                    ResourceFileFormat = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ResourceFilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Cancelled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageResources_LanguageId_Module",
                table: "LanguageResources",
                columns: new[] { "LanguageId", "Module" });
